...
urlpatterns = [
    ...
    path('book/appointment', views.book_adult_appointment, name='add_adult_appointment'),
    path('appointments/', views.book_child_appointment, name='add_child_appointment'),
